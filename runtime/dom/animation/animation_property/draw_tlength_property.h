...
namespace TaroAnimate {
    class AnimationPropDrawTLength : public AnimationPropBase {
        public:
        explicit AnimationPropDrawTLength(CSSProperty::Type prop_type);
    ...
    private:
        void setTLengthValue(CSSProperty::Type prop_type,
            std::shared_ptr<TaroDOM::TaroRenderNode>& node,
