...
#include "js_big_string.h"
#include "message_queue_thread.h"
#include "method_call.h"
#include "module_registry.h"
#include "systrace_section.h"
...
class JsToNativeBridge : public ExecutorDelegate {
    public:
    JsToNativeBridge(
...
void NativeToJsBridge::loadBundle(
    ...
    runOnExecutorQueue(
        [this,
         ...
         startupScriptSourceURL = std::move(startupScriptSourceURL)](JSExecutor* executor) mutable {
            try {
                executor->loadBundle(
